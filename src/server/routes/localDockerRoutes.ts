...
export const createLocalDockerRouter = (localDockerScanService: LocalDockerScanService) => {
  const router = Router();
  const localDockerController = new LocalDockerController(localDockerScanService);
